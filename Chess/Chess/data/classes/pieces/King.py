				...
				if queenside_rook != None:
					if not queenside_rook.has_moved:
						if [
							...
							if not board.is_in_check('white', board_change=[(4,7), (3,7)]):
								if not board.is_in_check('white', board_change=[(4, 7), (2, 7)]):
									if not board.is_in_check('white', board_change=[(4, 7), (1, 7)]):
										return 'queenside'
				if kingside_rook != None:
					if not kingside_rook.has_moved:
						if [
							...
							if not board.is_in_check('white', board_change=[(4,7), (5,7)]):
								if not board.is_in_check('white', board_change=[(4, 7), (6, 7)]):
									return 'kingside'
				...
				if queenside_rook != None:
					if not queenside_rook.has_moved:
						if [
							...
							if not board.is_in_check('black', board_change=[(4,0), (3,0)]):
								if not board.is_in_check('black', board_change=[(4, 0), (2, 0)]):
									if not board.is_in_check('black', board_change=[(4, 0), (1, 0)]):
										return 'queenside'
				if kingside_rook != None:
					if not kingside_rook.has_moved:
						if [
							...
							if not board.is_in_check('black', board_change=[(4,0), (5,0)]):
								if not board.is_in_check('black', board_change=[(4, 0), (6, 0)]):
									return 'kingside'
